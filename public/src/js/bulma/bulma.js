        ...
        function (e, t, n) {
            ...
            (a.VERSION = "0.12.1"),
                ...
                (a.parseDocument = function () {
                    var e =
                        ...
                        t = Object.keys(a.plugins).sort(function (e, t) {
                            return (
                                a.plugins[e].priority < a.plugins[t].priority
                            );
                        });
                    a.each(t, function (t) {
                ...
                (a._stripScripts = function (e) {
                    ...
                    t.innerHTML = e;
                    for (
                        var n = t.getElementsByTagName("script"), o = n.length;
                        o--;
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    a.getGlobalConfig("autoParseDocument", !0) &&
                        a.parseDocument(),
                        a.getGlobalConfig("onLoaded") &&
                            a.getGlobalConfig("onLoaded")();
                }),
                (t.default = a);
        },
            ...
            var u = (function () {
                function e() {
                    ...
                    if (
                        ...
                        throw new Error(
                            "A plugin requires a root and/or a parent."
                        );
            ...
            var a = (function () {
                function e() {
                    ...
                    if (
                        ...
                        throw new TypeError(
                            "initialConfig must be of type object."
                        );
                    this._items = t;
                }
                return (
                ...
                function t(e, n, o) {
                    ...
                    return (
                        ...
                        (i.dismissInterval = i.config.get("dismissInterval")
                            ? i.createDismissInterval(
                                  i.config.get("dismissInterval")
                              )
                            : null),
            ...
            var s = (t.Modal = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        ...
                        o.root.classList.contains("modal") ||
                            o.root.classList.add("modal"),
                        o.parent
        ...
        function (e, t, n) {
            ...
            var l = (t.Notification = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        o.isDismissable &&
                            (o.config.has("closeButton") ||
                                o.prependCloseButton(),
                            o.setupCloseEvent()),
                                    ...
                                    i.default.each(t, function (e) {
                                        ...
                                        if (!t.data("notification")) {
                                            ...
                                            t.notification({
                                                ...
                                                isDismissable: !!n,
                                                destroyOnDismiss: !0,
                                                dismissInterval: e.hasAttribute(
                                                    "data-dismiss-interval"
                                                )
                                                    ? e.getAttribute(
                                                          "data-dismiss-interval"
                                                      )
            ...
            i.default.registerPlugin("notification", l),
                (t.default = i.default);
        },
        function (e, t, n) {
            "use strict";
            ...
            var l = (t.Navbar = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        null === r.parent &&
                            (r.parent = r.config.get("root").parentNode),
                        (r.root = r.config.get("root")),
                        r.root.setAttribute("data-bulma-attached", "attached"),
                        (r.triggerElement =
                            r.root.querySelector(".navbar-burger")),
                        (r.target = r.root.querySelector(".navbar-menu")),
                        (r.sticky =
                            "object" ===
                                ("undefined" == typeof window
                                    ? "undefined"
                                    : o(window)) && !!r.config.get("sticky")),
                        (r.stickyOffset = parseInt(
                            r.config.get("stickyOffset")
                        )),
                        (r.hideOnScroll = !!r.config.get("hideOnScroll")),
                        (r.tolerance = parseInt(r.config.get("tolerance"))),
                        (r.shadow = !!r.config.get("shadow")),
                        (r.hideOffset = parseInt(
                            r.config.get(
                                "hideOffset",
                                Math.max(r.root.scrollHeight, r.stickyOffset)
                            )
                        )),
                        (r.lastScrollY = 0),
                        (r.dropdowns = r.root.querySelectorAll(
                            ".navbar-item.has-dropdown:not(.is-hoverable)"
                        )),
                        (r.handleScroll = r.handleScroll.bind(r)),
                        (0, i.default)(r.root).data("navbar", r),
                        r.registerEvents(),
                        r
                    );
                }
                    ...
                    r(t, null, [
                        {
                            ...
                            value: function (e) {
                                ...
                                (t =
                                    "object" === o(e.classList) &&
                                    e.classList.contains("navbar")
                                        ? [e]
                                        : e.querySelectorAll(".navbar")),
                                    i.default.each(t, function (e) {
                                        (0, i.default)(e).navbar({
                                            sticky: !!e.hasAttribute(
                                                "data-sticky"
                                            ),
                                            stickyOffset: e.hasAttribute(
                                                "data-sticky-offset"
                                            )
                                                ? e.getAttribute(
                                                      "data-sticky-offset"
                                                ...
                                                : 0,
                                            hideOnScroll: !!e.hasAttribute(
                                                "data-hide-on-scroll"
                                            ),
                                            tolerance: e.hasAttribute(
                                                "data-tolerance"
                                            )
                                                ? e.getAttribute(
                                                      "data-tolerance"
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                if (
                                    ...
                                    var t = this.calculateScrollDirection(
                                            e,
                                            this.lastScrollY
                                        ),
                                        n =
            ...
            var l = (t.Dropdown = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        ...
                        (o.triggerElement =
                            o.root.querySelector(".dropdown-trigger")),
                        o.registerEvents(),
                        (0, i.default)(o.root).data("dropdown", o),
                        o.trigger("init"),
                        o
                    );
                }
            ...
            var u = (t.Alert = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        ...
                        (0, s.default)(o.root).data("alert", o),
                        o.trigger("init"),
                        o.open(),
                        o
                    );
                    ...
                    i(t, [
                        {
                            ...
                            value: function () {
                                if (this.config.get("showHeader")) {
                                    this.header = s.default.findOrCreateElement(
                                        ".modal-card-head",
                                        this.content,
                                        "header",
                                        [
                                    ...
                                    var e =
                                        "warning" == this.config.get("type")
                                            ? "black"
                                            : "white";
                                    (this.headerTitle = s.default.createElement(
                                        "p",
                                        ["modal-card-title", "has-text-" + e]
                                    )),
                                        (this.headerTitle.innerHTML =
                                            this.title),
                                ...
                                (this.cardBody = s.default.findOrCreateElement(
                                    ".modal-card-body",
                                    this.content,
                                    "section"
                                )),
            ...
            var l = (t.File = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        ...
                        o.registerEvents(),
                        (0, i.default)(o.root).data("file", o),
                        o.trigger("init"),
                        o
                    );
                }
                            ...
                            value: function () {
                                ...
                                this.filename &&
                                    this.input.addEventListener(
                                        "change",
                                        this.handleTriggerChange.bind(this)
                                    ),
            ...
            var l = (t.Tabs = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        ...
                        o.setupNavEvents(),
                        (0, i.default)(o.root).data("tabs", o),
                        o.trigger("init"),
                        o
                    );
                }
                    ...
                    r(t, null, [
                        {
                            ...
                            value: function (e) {
                                ...
                                (t =
                                    "object" === o(e.classList) &&
                                    e.classList.has("tabs-wrapper")
                                        ? [e]
                                        : e.querySelectorAll(".tabs-wrapper")),
                                    i.default.each(t, function (e) {
                                        (0, i.default)(e).tabs({
                                            hover: !!e.hasAttribute(
                                                "data-hover"
                                            ),
                                        });
                                    });
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                i.default.each(this.navItems, function (e) {
                                    ...
                                    this.contentItems[e].classList.add(
                                        "is-active"
                                    );
                            },
                        },
            ...
            var l = (t.PanelTabs = (function (e) {
                function t(e, n) {
                    ...
                    return (
                        ...
                        (o.contentItems = o.findContentItems()),
                        o.setupNavEvents(),
                        o.on("init", o.showActiveTab.bind(o)),
                        (0, i.default)(o.root).data("panelTabs", o),
                        o.trigger("init"),
                        o
                    );
                }
                    ...
                    r(t, null, [
                        {
                            ...
                            value: function (e) {
                                ...
                                (t =
                                    "object" === o(e.classList) &&
                                    e.classList.contains("panel")
                                        ? [e]
                                        : e.querySelectorAll(".panel")),
                                    i.default.each(t, function (e) {
                                        null !==
                                            e.querySelector(".panel-tabs") &&
                            ...
                            value: function (e) {
                                this.navItems.forEach(function (t) {
                                    ...
                                    this.contentItems.forEach(function (t) {
                                        t.getAttribute("data-category") === e ||
                                        null === e
...
(function () {
    // Función para cerrar todos los dropdowns activos excepto el que se está abriendo
    ...
    // Función para cerrar todos los dropdowns activos cuando se hace clic fuera de ellos
    function closeDropdownOnOutsideClick(event) {
        var dropdown = document.querySelector(".dropdown.is-active");
        if (dropdown && !dropdown.contains(event.target)) {
            dropdown.classList.remove("is-active");
        }
    }

    // Agregar un evento clic a toda la página para cerrar otros dropdowns y para cerrar los dropdowns activos cuando se hace clic fuera de ellos
    document.addEventListener("click", function (event) {
        var clickedDropdown = event.target.closest(".dropdown");
        if (clickedDropdown) {
