...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permiso::insert([
            ["name" => "Todos los modulos | Acceso a Santa Cruz", "content_type" => "ciudades", "code_content" => 'Santa-Cruz'],
            ["name" => "Todos los modulos | Acceso a Chuquisaca", "content_type" => "ciudades", "code_content" => 'Chuquisaca'],
            ["name" => "Todos los modulos | Acceso a Cochabamba", "content_type" => "ciudades", "code_content" => 'Cochabamba'],
            ["name" => "Todos los modulos | Acceso a Potosi", "content_type" => "ciudades", "code_content" => 'Potosi'],
            ["name" => "Todos los modulos | Acceso a Potosi", "content_type" => "ciudades", "code_content" => 'Beni'],
            ["name" => "Todos los modulos | Acceso a Potosi", "content_type" => "ciudades", "code_content" => 'La-Paz'],
            ["name" => "Todos los modulos | Acceso a Potosi", "content_type" => "ciudades", "code_content" => 'Pando'],
            ["name" => "Todos los modulos | Acceso a Potosi", "content_type" => "ciudades", "code_content" => 'Tarija'],
            ["name" => "Todos los modulos | Acceso a Potosi", "content_type" => "ciudades", "code_content" => 'Oruro'],
            ["name" => "Todos los modulos | Acceso a Potosi", "content_type" => "ciudades", "code_content" => 'Otros'],
