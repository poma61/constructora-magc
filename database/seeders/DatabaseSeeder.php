...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Permiso::insert([
            //["name" => "Acceso a Chuquisaca", "type" => "all_module", "type_content" => "cities", "code" => 'Chuquisaca'] 
            ...
            //  ["name" => "Modulo Clientes | Santa Cruz | Grupo 01", "type" => "module_cliente",  "type_content" => "groups", "code" => 'Santa-Cruz_01'],
